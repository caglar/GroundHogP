...
def get_data(state):
    ...
    path = "/data/lisa/exp/caglargul/codes/python/nbit_parity_data/par_fil_npar_30_nsamp_400000.npy"
...
if __name__=='__main__':
    ...
    state['trainFreq'] = 100 #100
    state['validFreq'] = 400 #1000
    ...
    state["cost_tau"] = 1.00000006
    state["cost_scales"] = [0.1, 0.99]
    state["cost_scale_min"] = 0.25
